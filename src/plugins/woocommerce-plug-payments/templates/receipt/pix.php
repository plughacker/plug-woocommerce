...
<div class="order_details container" style="padding: 20px;position: relative;">
    <div class="plug_pix_qr_code">
        <img src="<?php echo esc_attr($payment_data['paymentMethod']['qrCodeImageUrl']); ?>" width="800px" alt="QRCode"/>
    </div>

    <div style="display: flex; height:inherit; justify-content: space-between; flex-direction: column; margin-left: 20px">
        <strong id="plug_qr_data"><?php echo esc_attr($payment_data['paymentMethod']['qrCodeData']); ?></strong> </br>
        <input type="hidden" value="<?php echo esc_attr($payment_data['paymentMethod']['qrCodeData']); ?>" /><br />
