...
<div class="error">
	<p><strong><?php esc_html_e( 'Plug Payments', 'plug-payments-gateway' ); ?></strong> <?php esc_html_e( 'depends on the last version of Extra Checkout Fields for Brazil to work!', 'plug-payments-gateway' ); ?><br /><i><?php esc_html_e( 'only for Pix, Boleto or Fraud analysis', 'plug-payments-gateway' ); ?></i></p>
